...
<body class="text-center">
  ...
  <main class="form-signin">
    <header>
      <div><h1 class="h3 mb-3 fw-normal">Login Admin</h1></div>
      <nav>
...
<h3>Connexion</h3>
 <form name="form1" method="post" action="pages/traitementlogina.php">

 <div class="form-floating">

   <input type="text" name="login" id="login" required autofocus
   placeholder="Login admin" maxlength="40" class="form-control"/>
