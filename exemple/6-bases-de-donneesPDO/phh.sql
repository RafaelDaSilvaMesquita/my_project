...
--
-- Hôte : 127.0.0.1
-- Généré le : jeu. 25 mai 2023 à 17:50
...
INSERT INTO `film` (`id`, `titre`, `date`, `softdelete`) VALUES
(1, 'Les Tontons Fligueurs', 1963, NULL),
(2, 'La guerre des étoiles V', 1980, NULL),
(3, 'V for Vendetta', 2005, NULL),
(4, 'The blues brothers', 1980, NULL),
(5, 'Le tatoué', 1968, NULL),
(6, 'Shining', 1980, NULL),
(7, 'Elephant Man', 1980, NULL),
(8, 'Un Mauvais fils', 1980, NULL),
(9, 'Les Aventuriers de l\'Arche perdue', 1981, NULL),
(10, 'Garde à vue', 1981, NULL),
(11, 'Blow Out', 1981, NULL),
(12, 'Mad Max 2', 1981, NULL),
(13, 'Brubaker', 1980, NULL);
